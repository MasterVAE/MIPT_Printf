...
; =======================================================================
; Трамплин для принта
; Вызывается из Си и подгатавливает стек для вызова функции printf
; =======================================================================
_my_printf:     
...
; =======================================================================
; Си-подобная функция printf
; Получает аргументы из стека
; Уничтожает: rax, rbx, rcx, r14
; =======================================================================
_printf:
                mov r14, rsp
                add r14, 6 * REG_SIZE 
...
;=========================================================================
; Печатает значение из стека как символ
;=========================================================================
char:
                mov rax, [r14]
                add r14, 8
...
;=========================================================================
; Печатает значение из стека как число в 16-ричной системе
;=========================================================================
hex:
                mov rax, [r14]
                add r14, 8
...
;=========================================================================
; Печатает значение из стека как 8-ричное число
;=========================================================================
octo:
                mov rax, [r14]
                add r14, 8
...
;=========================================================================
; Печатает значение из стека как 2-ичное число
;=========================================================================
bin:
                mov rax, [r14]
                add r14, 8
...
;=========================================================================
; Печатает значение из стека как 10-чное число
;=========================================================================
decimal:
                mov rax, [r14]
                add r14, 8
...
;=========================================================================
; Печатает значение из стека как строку
;=========================================================================
string:
                mov rdx, [r14]
                add r14, 8
...
; =======================================================================
; Печать символа
; Вводит символ из перменной Symbol в буффер печати
; =======================================================================
_print_symbol:
                push rax     
                push rbx
...
; =======================================================================
; Печать буффера
; Печатает все содержимое буффера одним вызовом
; =======================================================================
_print_buffer:
                push rax     
                push rdi
...
; =======================================================================
; в rax возвращает длину строки, переданной в rbx до END_SYMBOL 
; =======================================================================
_strlen:
                push rcx
